...
(function (ViewModels) {
    (function (Desktop) {
        var PlayerViewModel = (function () {
            function PlayerViewModel(playerContainer) {
                var _this = this;
            ...
            PlayerViewModel.prototype.isFlashPlayerEnabled = function () {
                return $("#flash").hasClass("selected");
            };

            PlayerViewModel.prototype.switchToSmoothStreaming = function () {
            ...
            PlayerViewModel.prototype.switchToMpegDash = function () {
                if (this.isFlashPlayerEnabled()) {
            ...
            PlayerViewModel.prototype.setPlayerSource = function (asset, changingPlayer) {
                if (typeof changingPlayer === "undefined") { changingPlayer = false; }
                if (!this.isFlashPlayerEnabled()) {
            ...
            PlayerViewModel.prototype.setupVideoPlayer = function () {
        ...
        Desktop.PlayerViewModel = PlayerViewModel;
    })(ViewModels.Desktop || (ViewModels.Desktop = {}));
    var Desktop = ViewModels.Desktop;
})(ViewModels || (ViewModels = {}));
//# sourceMappingURL=PlayerViewModel.Desktop.js.map
